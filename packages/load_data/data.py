...
from packages.load_data.datasets import TINDataset, _Getdata

from packages.load_data.augmentation import MNIST_Transforms, CIFAR10_Transforms, CIFAR10_AlbumTrans, TinyImageNet_AlbumTrans
...
class MNISTDataLoader:
    ...
    def __init__(self, model_transform, batch_size=64, data_dir= './root', shuffle=True, nworkers=4, pin_memory=True):
        ...
        self.train_set = datasets.MNISTTinyImageNetDataLoader(
            self.data_dir,
            train=True,
            download=True,
